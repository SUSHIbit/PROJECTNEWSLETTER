        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div class="mt-6 border-b border-gray-200">
                <nav class="flex space-x-8">
                    ...
                    <a href="{{ route('follow.following', $user->id) }}" 
                       class="py-2 px-1 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300">
                        Following
                    </a>
                </nav>
                        ...
                        <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    @if($follower->bio)
                                        <p class="text-sm text-gray-600">{{ Str::limit($follower->bio, 80) }}</p>
                                    @endif
                            ...
                            @auth
                                @if(Auth::id() !== $follower->id)
                                    <form action="{{ route('follow.toggle', $follower->id) }}" method="POST" class="inline">
                                        @csrf
        ...
        @else
            ...
            <div class="bg-white rounded-lg shadow-sm p-12 text-center">
                ...
                <p class="text-gray-500">
                    {{ $user->id === Auth::id() ? 'You don\'t have any followers yet.' : $user->display_name . ' doesn\'t have any followers yet.' }}
                </p>
            </div>
        @endif
    </div>
